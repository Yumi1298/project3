...
// parameter參數1 是要控制的對象
// parameter參數2 是duration
// parameter參數3 是要控制對象的原始狀態
// parameter參數4 是要控制對象的動畫結束後的狀態
// parameter參數5 提早時間開始跑
// Power2.easeInOut 為gsap中的屬性，x:-100% x為gsap寫法，CSS寫成translateX(-100%)
time_line
...
<div class="grader">
  ...
  // select可直接用JS更改
  graders = document.querySelectorAll("div.grader"); // 因為她是靜態的，所以需要再重抓一次
  for (let i = 0; i < graders.length; i++) {
